...
void Evaluator_Add(Evaluator *self, const Board *in_board, int in_value)
{
	...
	Evaluator_AddPattern(self, PATTERN_ID_DIAG4, self->MirrorLine[index * POW_3_4], index, diff);
	Evaluator_AddPattern(self, PATTERN_ID_EDGE8, BOARD_INDEX_8(in_board, A1, B1, C1, D1, E1, F1, G1, B2), -1, diff);
	Evaluator_AddPattern(self, PATTERN_ID_EDGE8, BOARD_INDEX_8(in_board, H1, G1, F1, E1, D1, C1, B1, G2), -1, diff);
	Evaluator_AddPattern(self, PATTERN_ID_EDGE8, BOARD_INDEX_8(in_board, A8, B8, C8, D8, E8, F8, G8, B7), -1, diff);
	Evaluator_AddPattern(self, PATTERN_ID_EDGE8, BOARD_INDEX_8(in_board, H8, G8, F8, E8, D8, C8, B8, G7), -1, diff);
	Evaluator_AddPattern(self, PATTERN_ID_EDGE8, BOARD_INDEX_8(in_board, A1, A2, A3, A4, A5, A6, A7, B2), -1, diff);
	Evaluator_AddPattern(self, PATTERN_ID_EDGE8, BOARD_INDEX_8(in_board, A8, A7, A6, A5, A4, A3, A2, B7), -1, diff);
	Evaluator_AddPattern(self, PATTERN_ID_EDGE8, BOARD_INDEX_8(in_board, H1, H2, H3, H4, H5, H6, H7, G2), -1, diff);
	Evaluator_AddPattern(self, PATTERN_ID_EDGE8, BOARD_INDEX_8(in_board, H8, H7, H6, H5, H4, H3, H2, G7), -1, diff);
